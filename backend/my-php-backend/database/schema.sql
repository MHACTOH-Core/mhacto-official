...
('hero', 'hero_title_2',      '"Discover The Culture"', 'string'),
('hero', 'hero_highlight_2',  '"Of Bocaue"', 'string'),
('hero', 'hero_title_3',      '"Experience The Festivals"', 'string'),
('hero', 'hero_highlight_3',  '"& Traditions"', 'string'),
('hero', 'hero_title_4',      '"Taste The Authentic"', 'string'),
('hero', 'hero_highlight_4',  '"Local Cuisine"', 'string'),
