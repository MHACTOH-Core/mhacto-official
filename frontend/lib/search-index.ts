...
export const searchIndex: SearchResult[] = [
  ...
  { id: "page-local-business", title: "Local Businesses",     subtitle: "Businesses in Bocaue",                href: "/arts-livelihood/local-business", category: "Page", keywords: "local business commerce enterprises" },
