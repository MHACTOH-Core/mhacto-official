...
const sections = [
  {
    ...
    description:
      "Meet the entrepreneurs and local enterprises that drive Bocaue's economy — from traditional trading to modern small businesses.",
  ...
  },
  {
    title: "Crafts",
    description:
      "Discover the skilled artisans of Bocaue — masters of weaving, woodcarving, and other crafts that have been practiced for generations.",
    href: "/arts-livelihood/crafts-artisans",
    icon: Scissors,
      ...
      >
        <div className="px-6 pb-10 pt-20 lg:px-16">
          ...
          <p className="mt-2 max-w-xl text-sm text-white/80 sm:text-base">
            Explore the craft traditions and local industries that sustain
            Bocaue's vibrant community.
          </p>
        </div>
      </section>
